...
from customer_behaviour_analysis 
where discount_applied = 'Yes' and purchased_amount >= (select AVG(purchased_amount) from customer_behaviour_analysis)


-- Q3. Which are the top 5 products with the highest average review rating?
select top 5 item_purchased, avg(review_rating::numeric) as "Average Product Rating"
from customer_behaviour_analysis
